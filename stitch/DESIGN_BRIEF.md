...
- StackLens Canary Clean turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser tool called StackLens Canary Clean. It should be a small operational dashboard for comparing module stack health across projects. Use a frontend web app stack, not a game. No database required. First viewport must be the actual dashboard with module cards, stack status, risk indicator…
...
- Record Operations - StackLens Canary Clean
- Record Editor - StackLens Canary Clean
- Insights - StackLens Canary Clean

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - StackLens Canary Clean
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - StackLens Canary Clean
...
SCREEN_SPEC_3:
- exact_screen_title: Insights - StackLens Canary Clean
